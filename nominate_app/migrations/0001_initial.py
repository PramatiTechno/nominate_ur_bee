# Generated by Django 2.1 on 2019-09-16 14:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='NominationTiming',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_day', models.DateField()),
                ('end_day', models.DateField()),
                ('review_start_day', models.DateField()),
                ('review_end_day', models.DateField()),
                ('approval_start_day', models.DateField()),
                ('approval_end_day', models.DateField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('award_template', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='nominate_app.AwardTemplate')),
            ],
        ...
        migrations.AddField(
            ...
            name='nomination_timing',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nominate_app.NominationTiming'),
        ),
        migrations.AddField(
            model_name='like',
            name='submission',
